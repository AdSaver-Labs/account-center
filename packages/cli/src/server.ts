...
<body>
  ...
  <script>
    (function () {
      ...
      function authChallengeCancellationCapability(capabilityData) { return exactMutationCapability(capabilityData, 'auth_challenges.cancel', '/api/auth-challenges/:id/cancel', ['bearer_token', 'same_origin', 'opaque_challenge_id', 'explicit_runtime_scope', 'durable_challenge_store', 'durable_audit_store']); }
