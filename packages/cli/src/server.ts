  ...
  <script>
    (function () {
      ...
      function renderWorkspace(data, unavailable) {
        ...
        renderAccountVisibility(data.limits, data.preferences, unavailable.preferences || unavailable.limits);
