...
<head>
  ...
  <style>
    .more-basics{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0 0 14px}.more-basics article{border:1px solid var(--line);border-radius:7px;background:var(--panel-2);padding:11px;min-width:0}.more-basics h2{margin:0;font-size:14px}.more-basics p{margin:5px 0 0;color:var(--muted);font-size:12px}.advanced-disclosure{border:1px solid var(--line);border-radius:var(--radius);background:var(--panel);padding:0 14px}.advanced-disclosure summary{display:flex;align-items:center;justify-content:space-between;gap:12px;min-height:52px;cursor:pointer;color:var(--text)}.advanced-disclosure summary strong{font-size:14px}.advanced-disclosure summary span{color:var(--muted);font-size:12px}.advanced-content{padding:2px 0 14px}.advanced-content>.view{margin-top:14px}@media(max-width:640px){.view-heading{align-items:flex-start;flex-direction:column}.more-basics{grid-template-columns:1fr}.advanced-disclosure summary{align-items:flex-start;flex-direction:column;justify-content:center}.advanced-disclosure summary span{padding-left:20px}}
  </style>
</head>
<body>
