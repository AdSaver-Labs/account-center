...
<head>
  ...
  <style>
    .context-selector{display:flex;align-items:end;justify-content:space-between;gap:16px;margin:0 0 14px;padding:12px 14px;border:1px solid var(--line);border-radius:var(--radius);background:var(--panel)}.context-selector h2{margin:0;font-size:13px}.context-selector p{max-width:580px;margin:4px 0 0;color:var(--muted);font-family:system-ui,sans-serif;font-size:12px}.context-selector .field{width:min(340px,100%)}.context-selector select:disabled{opacity:1;color:var(--muted);cursor:not-allowed}.tabs{display:flex;gap:8px;overflow:auto;padding:4px 0 14px}.tab{min-height:36px;border:1px solid var(--line);border-radius:6px;background:transparent;color:var(--muted);padding:0 11px;white-space:nowrap}.tab[aria-selected="true"]{border-color:#376858;color:var(--accent);background:var(--panel-2)}.view[hidden]{display:none}.view-heading{display:flex;justify-content:space-between;gap:12px;align-items:baseline;margin:4px 0 14px}.view-heading h2{font-size:16px;margin:0}.view-heading p{margin:0;color:var(--muted);font-family:system-ui,sans-serif;font-size:13px}.record-list{display:grid;gap:8px}.record{border:1px solid var(--line);border-radius:7px;background:var(--panel-2);padding:11px}.record strong{display:block}.record p{margin:5px 0 0;color:var(--muted);font-family:system-ui,sans-serif;font-size:12px}.catalog-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.secondary{margin-top:14px}@media(max-width:760px){.context-selector{align-items:stretch;flex-direction:column}.catalog-grid{grid-template-columns:1fr}.tabs{margin:0 -2px}}
  </style>
</head>
<body>
